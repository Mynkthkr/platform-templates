...
.env:
	@ if [ ! "${AWS_SECRET_ACCESS_KEY}" = "" ]; then echo "AWS_ACCESS_KEY_ID=${AWS_ACCESS_KEY_ID}" > .env-auth; echo  "AWS_SECRET_ACCESS_KEY=${AWS_SECRET_ACCESS_KEY}" >> .env-auth; echo "TF_LOG=DEBUG" >> .env-auth;fi
